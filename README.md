...
Una app de lista de regalos navideña, donde hacemos la misma aplicacion 23 veces, en 23 dias, agregandole una nueva feature cada dia. La idea es aprender a traves de repeticion, cada dia se tiene que empezar de 0
